...
export default class MonitorScreen extends EventEmitter {
    ...
    createIframe() {
        ...
        // PROD
        iframe.src = 'https://herambkataru-os.firebaseapp.com/';
        /**
         * Use dev server is query params are present
         *
         * Warning: This will not work unless the dev server is running on localhost:3001
